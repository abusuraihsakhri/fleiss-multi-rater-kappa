"""
Command Line Interface for Fleiss Multi Rater Kappa.
"""
import argparse
import csv
import json
...
def main(argv=None):
    parser = argparse.ArgumentParser(prog="fleiss-multi-rater-kappa", description="Fleiss Multi Rater Kappa")
    ...
    if args.command == "audit":
        ...
        print("=" * 80)
        print(f"  FLEISS MULTI RATER KAPPA")
    ...
    if args.command == "chat":
        ...
        print(f"\n[Fleiss Multi Rater Kappa Supervisor]:\n{ans}\n")
        return 0
    ...
    if args.command == "serve":
        ...
        print(f"Starting Fleiss Multi Rater Kappa API server on http://{args.host}:{args.port}")
