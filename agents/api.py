"""
FastAPI REST API Server for Fleiss Multi Rater Kappa.
"""
...
app = FastAPI(
    title="Fleiss Multi Rater Kappa API",
...
@app.get("/health")
def health():
    return {"status": "HEALTHY", "service": "fleiss-multi-rater-kappa", "domain": "Clinical & Biomedical AI", "standard": "CAP / CLSI / ISO Standards", "version": "3.0.0-ENTERPRISE"}
